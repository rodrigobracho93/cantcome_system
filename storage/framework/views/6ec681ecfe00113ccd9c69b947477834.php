...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body class="font-sans text-gray-900 dark:text-white antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center px-4 pt-6 sm:pt-0 bg-gradient-to-br from-gray-50 to-indigo-50 dark:from-gray-900 dark:to-indigo-950">
            ...
            <p class="mt-6 text-xs text-gray-400 dark:text-gray-500"><?php echo e($systemName ?? 'CantCome'); ?> &copy; <?php echo e(date('Y')); ?> &mdash; Todos los derechos reservados</p>
        </div>
    </body>
</html>
<?php /**PATH C:\xampp\Proyectos\cantcome_system\resources\views/layouts/guest.blade.php ENDPATH**/ ?>