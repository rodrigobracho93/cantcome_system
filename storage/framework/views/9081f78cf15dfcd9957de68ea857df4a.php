        ...
        <div x-data="{
            ...
            <div class="shrink-0">
                <?php if($user->profile_photo_url): ?>
                    <img src="<?php echo e($user->profile_photo_url); ?>" alt="<?php echo e($user->name); ?>" class="w-20 h-20 rounded-full object-cover border-2 border-gray-200">
                <?php else: ?>
...
<?php /**PATH C:\xampp\Proyectos\cantcome_system_ho\resources\views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>