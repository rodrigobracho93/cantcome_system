...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Configuración <?php $__env->endSlot(); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6" x-data="brandingPreview()">
            ...
            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-5 text-center mb-5">
                <img :src="previewUrl || '<?php echo e(asset($settings['system_logo'])); ?>'" class="h-16 w-auto mx-auto mb-3 rounded-lg" alt="Logo actual">
                <p class="text-sm font-semibold text-gray-800 dark:text-gray-200" x-text="'<?php echo e($settings['system_name']); ?>'"></p>
                <p class="text-[10px] text-gray-400 dark:text-gray-500 mt-1">Logo actual</p>
            </div>

            <form action="<?php echo e(route('admin.settings.branding')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="system_name" value="<?php echo e(old('system_name', $settings['system_name'])); ?>" maxlength="100"
                ...
                <div class="mb-5">
                    ...
                    <select name="timezone" class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                        ...
                        <?php $__currentLoopData = $timezones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tz => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($tz); ?>" <?php echo e($settings['timezone'] === $tz ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <div class="space-y-2 mt-1">
                            ...
                            ?>
                            <?php $__currentLoopData = $dateFormats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fmt => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="flex items-center gap-3 p-2.5 rounded-lg border cursor-pointer transition-all
                                <?php echo e($settings['date_format'] === $fmt ? 'border-indigo-500 bg-indigo-50 dark:bg-indigo-900/20 dark:border-indigo-600' : 'border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500'); ?>">
                                <input type="radio" name="date_format" value="<?php echo e($fmt); ?>" <?php echo e($settings['date_format'] === $fmt ? 'checked' : ''); ?>

                                    class="border-gray-300 dark:border-gray-600 text-indigo-600 focus:ring-indigo-500">
                                <div class="flex-1">
                                    <span class="text-xs font-medium text-gray-800 dark:text-gray-200"><?php echo e($info['label']); ?></span>
                                </div>
                                <span class="text-xs text-gray-400 dark:text-gray-500 font-mono"><?php echo e($info['example']); ?></span>
                            </label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-2 mt-1">
                            <label class="flex items-center gap-3 p-2.5 rounded-lg border cursor-pointer transition-all
                                <?php echo e($settings['time_format'] === '24h' ? 'border-indigo-500 bg-indigo-50 dark:bg-indigo-900/20 dark:border-indigo-600' : 'border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500'); ?>">
                                <input type="radio" name="time_format" value="24h" <?php echo e($settings['time_format'] === '24h' ? 'checked' : ''); ?>
                            ...
                            <label class="flex items-center gap-3 p-2.5 rounded-lg border cursor-pointer transition-all
                                <?php echo e($settings['time_format'] === '12h' ? 'border-indigo-500 bg-indigo-50 dark:bg-indigo-900/20 dark:border-indigo-600' : 'border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500'); ?>">
                                <input type="radio" name="time_format" value="12h" <?php echo e($settings['time_format'] === '12h' ? 'checked' : ''); ?>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center gap-3 mb-5">
                ...
                <div class="flex items-center gap-2">
                    <form action="<?php echo e(route('admin.backups.create')); ?>" method="POST" class="inline">
                        <?php echo csrf_field(); ?>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td class="px-4 py-3 text-right text-sm">
                                    <div class="flex items-center justify-end gap-1">
                                        <a :href="'<?php echo e(url('admin/backups')); ?>/' + b.filename + '/download'"
            ...
            <div class="mt-5 pt-4 border-t border-gray-100 dark:border-gray-700">
                <form action="<?php echo e(route('admin.backups.restore')); ?>" method="POST" enctype="multipart/form-data" class="flex items-center gap-3">
                    <?php echo csrf_field(); ?>
                    <div class="flex-1">
    ...
    <form id="resetForm" action="<?php echo e(route('admin.settings.branding.reset')); ?>" method="POST" class="hidden">
        <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        const configuredTimezone = <?php echo json_encode($settings['timezone'], 15, 512) ?>;
        ...
        function backupManager() {
            return {
                ...
                async loadBackups() {
                    this.loading = true;
                    try {
                        const res = await fetch('<?php echo e(route("admin.backups.list")); ?>', {
                ...
                async deleteBackup(filename) {
                    ...
                    await fetch('<?php echo e(url("admin/backups")); ?>/' + filename, {
                        method: 'DELETE',
...
<?php endif; ?>
<?php /**PATH C:\xampp\Proyectos\cantcome_system\resources\views/admin/settings.blade.php ENDPATH**/ ?>