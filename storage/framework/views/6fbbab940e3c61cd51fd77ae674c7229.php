...
<?php $component->withAttributes([]); ?>
    ...
    <form action="<?php echo e(route('sales.store')); ?>" method="POST" id="saleForm" class="lg:grid lg:grid-cols-5 lg:gap-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="lg:col-span-3 space-y-4 mb-6 lg:mb-0">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
                ...
                <div class="relative mb-3">
                    ...
                    <input type="text" id="customerSearch" autocomplete="off"
                        ...
                        <?php if(!empty($customerId)): ?> value="<?php echo e($customers->find($customerId)?->name ?? ''); ?>" <?php endif; ?>>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <span class="text-xs text-gray-400 dark:text-gray-500"><?php echo e($products->count()); ?> disponibles</span>
                ...
                <div id="productGrid" class="grid grid-cols-2 sm:grid-cols-3 gap-2 max-h-[420px] overflow-y-auto pr-1">
                    ...
                    <button type="button" onclick="addToCart(<?php echo e($product->id); ?>, '<?php echo e(addslashes($product->name)); ?>', <?php echo e($product->price); ?>, <?php echo e($product->stock); ?>)"
                        ...
                        data-name="<?php echo e(strtolower($product->name)); ?>" data-category="<?php echo e(strtolower($product->category?->name ?? '')); ?>">
                        ...
                        <p class="text-xs font-semibold text-gray-800 dark:text-gray-200 truncate leading-tight"><?php echo e($product->name); ?></p>
                        <p class="text-xs font-bold text-indigo-600 dark:text-indigo-400 mt-0.5">₲ <?php echo e(number_format($product->price, 0, ',', '.')); ?></p>
                        <span class="inline-block mt-1 text-[10px] font-medium px-1.5 py-0.5 rounded <?php echo e($product->stock > 10 ? 'bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400' : ($product->stock > 0 ? 'bg-amber-50 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400' : 'bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400')); ?>">
                ...
                <div id="productList" class="hidden max-h-[420px] overflow-y-auto pr-1 space-y-1.5">
                    ...
                    <button type="button" onclick="addToCart(<?php echo e($product->id); ?>, '<?php echo e(addslashes($product->name)); ?>', <?php echo e($product->price); ?>, <?php echo e($product->stock); ?>)"
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-semibold text-gray-800 dark:text-gray-200 truncate"><?php echo e($product->name); ?></p>
                            <?php if($product->category): ?>
                                <p class="text-[11px] text-gray-400 dark:text-gray-500 truncate"><?php echo e($product->category->name); ?></p>
                            <?php endif; ?>
                        </div>
                        <span class="text-xs font-medium px-1.5 py-0.5 rounded shrink-0 <?php echo e($product->stock > 10 ? 'bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400' : ($product->stock > 0 ? 'bg-amber-50 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400' : 'bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400')); ?>">
                            <?php echo e($product->stock); ?>

                        </span>
                        <p class="text-sm font-bold text-indigo-600 dark:text-indigo-400 whitespace-nowrap shrink-0">₲ <?php echo e(number_format($product->price, 0, ',', '.')); ?></p>
...
<?php endif; ?><?php /**PATH C:\xampp\Proyectos\cantcome_system\resources\views/sales/create.blade.php ENDPATH**/ ?>