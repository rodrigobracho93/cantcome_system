        ...
        <div class="flex items-center gap-1">
            ...
            <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center gap-2 pr-2 rounded-lg hover:bg-indigo-900/40 transition-colors">
                ...
                <div class="text-left hidden sm:block">
                    ...
                    <p class="text-[10px] font-medium text-indigo-300/70 leading-tight"><?php echo e($activeRole === 'admin' ? 'Administrador' : 'Cantina'); ?></p>
                </div>
            </a>
            ...
            <?php if(Auth::user()->isAdmin()): ?>
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open" class="flex items-center gap-1 px-2 py-1 text-[11px] font-medium text-indigo-300 rounded hover:bg-indigo-800/40 transition-colors">
                        ...
                        <span><?php echo e($activeRole === 'admin' ? 'Admin' : 'Cantina'); ?></span>
